...
function createTexture(glInfo, source, id, textureLocation) {
    ...
    image.addEventListener('load', function () {
        ...
        glInfo.gl.texImage2D(glInfo.gl.TEXTURE_2D, 0, glInfo.gl.RGBA, glInfo.gl.RGBA, glInfo.gl.UNSIGNED_BYTE, image);
